...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 07, 2020 at 01:10 PM
...
--
CREATE DATABASE IF NOT EXISTS `agroconnect` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `agroconnect`;
...
INSERT INTO `register` (`Sno.`, `aadhar`, `fullname`, `password`, `mobile`) VALUES
(1, 327372, 'Prashasti Agarwal', 'cfergregre', 2147483647);
...
-- Database: `epistemico`
--
CREATE DATABASE IF NOT EXISTS `epistemico` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `epistemico`;
...
('Prashasti', 'Agarwal', 'agarwalprashasti1999@gmail.com', '10000', '104'),
('Prachi', 'agarwal', 'pronchi@gmail.com', '102', '102'),
('ravi', 'mehta', 'ravi@gmail.com', '109', '101'),
('Rupali', 'Middha', 'rupali@gweca.ac.in', '112', '101'),
...
('Rupali', 'Middha', 'rupali@gweca.ac.in', '305', '101');
...
('root', '[{\"db\":\"agroconnect\",\"table\":\"register\"},{\"db\":\"loginsystem\",\"table\":\"doctorapp\"},{\"db\":\"epistemico\",\"table\":\"register\"},{\"db\":\"epestemico\",\"table\":\"registration_detail\"}]');
...
('root', '2019-01-31 08:29:03', '{\"collation_connection\":\"utf8mb4_unicode_ci\"}');
...
-- Database: `reena`
--
CREATE DATABASE IF NOT EXISTS `reena` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `reena`;
--
-- Database: `test`
--
